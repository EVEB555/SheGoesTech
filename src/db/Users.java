...
public class Users {
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(dbURL, username, password)){
            ...
            while(again == 'y'){
                ...
                again = scanner.nextLine().charAt(0); //this is how char is read
            }
    ...
    public static void readData(Connection conn) throws SQLException { //exception deals with error, so no need to put try/catch
